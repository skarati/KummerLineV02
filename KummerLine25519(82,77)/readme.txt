...
The .S files are used for 5-limb multiplication and squaring and are part of the Sandy2x code available from
...
Compile command:
gcc -m64 -mavx2 -O3 -fomit-frame-pointer main.c mul_gfe51.S nsq_gfe51.S consts.S
